...
(defun initialize-default-grammars ()
  (system-add
   ...
   (make-instance 'context-free-grammar-with-subroutines
                  ...
                  :crossover-tokens '(:0-ary-operator :1-ary-operator :2-ary-operator :3-ary-operator :expresion))
   (make-instance 'context-free-grammar-with-subroutines
   ...
   (make-instance 'context-free-grammar
                  ...
                  :crossover-tokens '(:values :1-ary-operator :2-ary-operator :3-ary-operator :expresion))
   (make-instance 'context-free-grammar
   ...
   (make-instance 'context-free-grammar
                  ...
                  :crossover-tokens '(:var :constant :termino :productoria-variables :expresion))
   (make-instance 'context-free-grammar
