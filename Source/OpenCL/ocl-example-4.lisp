...
(setf ee1 (make-instance 'entity-function-x-cl-evaluator :samples 8 :fitness-function 'evaluate-distance :target-program '(+ x 1)))
(setf ee2 (make-instance 'entity-function-x-evaluator :samples 8 #| 8388608 |# :fitness-function 'evaluate-distance :target-program '(+ x 1)))
...
(time 
 (dotimes (i 10000)
   (my-round-to-3 (evaluate ee1 (make-instance 'entity-function-x :expresion i)))))

(time
 (dotimes (i 10000)
   (my-round-to-3 (evaluate ee2 (make-instance 'entity-function-x :expresion i)))))
