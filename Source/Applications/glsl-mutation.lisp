...
'(((START EXPS) $1) 
  ...
  ((EXPTWO :OPEN REFLECT EXPTWO EXPTWO EXPONE :CLOSE) (SYSTEM::BQ-LIST :exptwo (SYSTEM::BQ-LIST $2 $3 $4 $5))) 
  ...
  ((EXPTHREE :OPEN REFLECT EXPTHREE EXPTHREE EXPONE :CLOSE) (SYSTEM::BQ-LIST :expthree (SYSTEM::BQ-LIST $2 $3 $4 $5))) 
  ...
  ((EXPFOUR :OPEN REFLECT EXPFOUR EXPFOUR EXPONE :CLOSE) (SYSTEM::BQ-LIST :expfour (SYSTEM::BQ-LIST $2 $3 $4 $5))) 
